                        ...
                        <tr>
                            ...
                            <td class="px-2 w-72 py-4">
                                <div class="flex text-center justify-center items-center gap-2">
                                    ...
                                    <button wire:click="changeStatus({{ $category->id }})" class="bg-green-500 admin-table-btn td-action">تغییر وضعیت</button>
                                    <button wire:click="delete({{ $category->id }})" class="bg-red-500 admin-table-btn td-action">حذف</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
